	 ...
	 */
	 ...
	 function get_toy(PDO $pdo, string $id) {
		...
		$sql = "SELECT *, manuf.name as manufname, toy.name as toyname
			FROM toy, manuf
			WHERE toynum= :id and manuf.manid= toy.manid;";	// :id is a placeholder for value provided later 
		...
		<main>
			...
			<div class="toy-details-container">
				<div class="toy-image">
					...
					<img src="<?= $toy_info['imgSrc'] ?>" alt="<?= $toy_info['toyname'] ?>">
				</div>

				<div class="toy-details">

					<!-- Display name of toy -->
			        <h1><?= $toy_info['toyname'] ?></h1>
			        ...
			        <p><strong>Name:</strong> <?= $toy_info['manufname'] ?> </p>
